    ...
    async componentDidMount() {
        ...
        if (this.props.firstEqualsLast) {
            ...
            if (firstInput.trim() != "") {
                ...
                url = `https://flask-service.a1cqh1bc24r90.us-east-1.cs.amazonlightsail.com/starts-and-ends-with?letter=${firstInput}`
        ...
        //startsWith - endsWith
            ...
            if (firstInput.trim() != "" && lastInput.trim() != "") {
                url = `https://flask-service.a1cqh1bc24r90.us-east-1.cs.amazonlightsail.com/starts-with-ends-with?first=${firstInput}&last=${lastInput}`
                const response = await fetch(url);
                const data = await response.json();
                this.setState({ noInput: false, words: data.words, wordCount: data.count});
            }
